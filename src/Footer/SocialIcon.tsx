...
export const FooterSocialIcon: React.FC<Props> = ({ label, url }) => {
  const network = resolveNetwork(label, url)

  return (
    <a
      aria-label={label}
      className="flex h-10 w-10 items-center justify-center rounded-full bg-graphite-800 text-white transition-colors hover:bg-solar-400 hover:text-graphite-900"
      href={url}
